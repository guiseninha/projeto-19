...
function preload(){
  ...
  obestacleImg= loadImage("obstacle1.png")
...
function obstacleG(){
  obstacle1 = createSprite(100,50);
obstacle2 = createSprite(100,50);
obstacle3 = createSprite(100,50);
obstacle1.y = Math.round(random(50, 250))
obstacle2.y=obstacle1.y;
obstacle33.y=obstacle1.y;
obstacle1.addImage(obstacle1Img);
obstacle2.addImage(obstacle2Img);
obstacle3.addImage(obstacle3Img);
  obstaclesGroup.velocityX = -(6 + 2*distance/150);
  obstaclesGroup.setLifetime=170;
  obstaclesGroup.add(obestacle1)
}
...
function reset (){
  gameState= PLAY;
  gameOver.visible=false;
  mainCyclist.changeAnimation ("mainCyclist",mainCyclist_running);
  pinkCGGroup.destroyEach();
  yellowCGGroup.destroyEach();
  redCGGroup.destroyEach();
score=0
